  ...
  return (
    <div className='absolute pt-72 px-12 text-white bg-gradient-to-r from-black w-screen aspect-video'>
        ...
        <div className='flex items-center gap-4'>
            <button className='p-2 bg-white text-black font-bold cursor-pointer px-4 rounded-sm hover:bg-white/60'>▶Play</button>
            <button 
            className='p-2 bg-gray-400/50 text-white font-bold flex cursor-pointer gap-2 hover:bg-gray-400/80 px-4 rounded-sm'>
